...
public class Mermin3 {
	...
	*/
	public int getResult(double settingA, double settingB, double spin) {
		//System.out.println("Trying: " + settingA + " " + settingB + " " + spin);
		...
		// there are two classes.  If we are within 90 degrees we go for green.  Outside 90 degrees, we go red.		
		...
		System.out.println("Sholdn'tt beh herree");
		return 3;
	}
